...
\\[\blanklineskip]%
\>[B]{}\Varid{baseFS}\;\Varid{f}\;\Varid{g}\;\Varid{h}\mathrel{=}\Varid{id}+(\Varid{f}\times((\Varid{g}\times\Varid{g})\times(\Varid{h}\times\Varid{h}))){}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{anaFS}\;\Varid{g}\mathrel{=}\bot {}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{hyloFS}\;\Varid{g}\;\Varid{h}\mathrel{=}\bot {}\<[E]%
\ColumnHook
\end{hscode}\resethooks
