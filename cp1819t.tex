...
\\
\>[B]{}\Varid{inExpr}\mathrel{=}\alt{\Conid{Num}}{\uncurry{((\Varid{result})\;\uncurry{\cdot }\;(\Varid{flip}\;\Conid{Bop}))}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{outExpr}\mathbin{::}\Conid{Expr}\to \Conid{Int}+(\Conid{Op},(\Conid{Expr},\Conid{Expr})){}\<[E]%
\\
\>[B]{}\Varid{outExpr}\;(\Conid{Num}\;\Varid{a})\mathrel{=}i_1\;(\Varid{a}){}\<[E]%
\\
...
\\
\>[B]{}\Varid{calcula}\mathrel{=}\Varid{cataExpr}\;\alt{\Varid{id}}{\Varid{cond}\;((\equiv \text{\ttfamily \char34 +\char34})\comp \Varid{getOp}\comp \p1)\;\Varid{f}\;\Varid{g}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{f}\mathrel{=}\uncurry{(\mathbin{+})}\comp \p2{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{g}\mathrel{=}\uncurry{(\mathbin{*})}\comp \p2{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
&
    \ensuremath{\Conid{Int}+(\Conid{Op},(\Conid{Expr},\Conid{Expr}))}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}(\Varid{f}\times(\Varid{calcula}\times\Varid{calcula}))}}
           \ar[l]_-{\ensuremath{\mathsf{in}}}
\\
     \ensuremath{\Conid{Int}}
&
     \ensuremath{\Conid{Int}+(\Conid{Op},(\Conid{Int},\Conid{Int}))}
           \ar[l]^-{\ensuremath{\Varid{g}}}
}
\end{eqnarray*}
...
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{show'}\mathbin{::}\Conid{Expr}\to \Conid{String}{}\<[E]%
\\
\>[B]{}\Varid{show'}\mathrel{=}\Varid{cataExpr}\;\alt{\Varid{show}}{\Varid{aux}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{aux}\;((\Conid{Op}\;\Varid{o}),(\Varid{s1},\Varid{s2}))\mathrel{=}\text{\ttfamily \char34 (\char34}\plus \text{\ttfamily \char34 (\char34}\plus \Varid{s1}\plus \text{\ttfamily \char34 )\char34}\plus \Varid{o}\plus \text{\ttfamily \char34 (\char34}\plus \Varid{s2}\plus \text{\ttfamily \char34 )\char34}\plus \text{\ttfamily \char34 )\char34}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
&
    \ensuremath{\Conid{Int}+(\Conid{Op},(\Conid{Expr},\Conid{Expr}))}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}(\Varid{f}\times(\Varid{show'}\times\Varid{show'}))}}
           \ar[l]_-{\ensuremath{\mathsf{in}}}
\\
     \ensuremath{\Conid{String}}
&
     \ensuremath{\Conid{Int}+(\Conid{Op},(\Conid{String},\Conid{String}))}
           \ar[l]^-{\ensuremath{\Varid{g}}}
}
\end{eqnarray*}
...
\\
\>[B]{}\Varid{compile}\mathrel{=}\Varid{cataExpr}\;\alt{\Varid{f}}{\Varid{cond}\;((\equiv \text{\ttfamily \char34 +\char34})\comp \Varid{getOp}\comp \p1)\;\Varid{g}\;\Varid{h}}\comp \p1\comp \Varid{head}\comp \Varid{readExp}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{f}\mathrel{=}\Varid{singl}\comp \Varid{criaString}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{g}\mathrel{=}\Varid{addSoma}\comp \uncurry{(\plus )}\comp \p2{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{h}\mathrel{=}\Varid{addMul}\comp \uncurry{(\plus )}\comp \p2{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\xymatrix@C=2cm{
    \ensuremath{\Conid{Expr}}
           \ar[d]_-{\ensuremath{\Varid{compile}}}
&
    \ensuremath{\Conid{Int}+(\Conid{Op},(\Conid{Expr},\Conid{Expr}))}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}(\Varid{f}\times(\Varid{compile}\times\Varid{compile}))}}
           \ar[l]_-{\ensuremath{\mathsf{in}}}
\\
     \ensuremath{\Conid{Codigo}}
&
     \ensuremath{\Conid{Int}+(\Conid{Op},(\Conid{Codigo},\Conid{Codigo}))}
           \ar[l]^-{\ensuremath{\Varid{g}}}
}
\end{eqnarray*}
...
\column{11}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{result}\mathbin{::}(\Varid{b}\to \Varid{b'})\to ((\Varid{a}\to \Varid{b})\to (\Varid{a}\to \Varid{b'})){}\<[E]%
\\
\>[B]{}\Varid{result}\mathrel{=}{}\<[11]%
\>[11]{}(\comp ){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{getOp}\mathbin{::}\Conid{Op}\to \Conid{String}{}\<[E]%
\\
\>[B]{}\Varid{getOp}\;(\Conid{Op}\;\Varid{o})\mathrel{=}\Varid{o}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{criaString}\mathbin{::}\Conid{Int}\to \Conid{String}{}\<[E]%
\\
\>[B]{}\Varid{criaString}\;\Varid{i}\mathrel{=}\text{\ttfamily \char34 PUSH~\char34}\plus \Varid{show}\;\Varid{i}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{addSoma}\mathbin{::}\Conid{Codigo}\to \Conid{Codigo}{}\<[E]%
\\
\>[B]{}\Varid{addSoma}\;\Varid{l}\mathrel{=}\uncurry{(\plus )}\;(\Varid{l},\Varid{singl}\;\text{\ttfamily \char34 ADD\char34}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{addMul}\mathbin{::}\Conid{Codigo}\to \Conid{Codigo}{}\<[E]%
\\
\>[B]{}\Varid{addMul}\;\Varid{l}\mathrel{=}\uncurry{(\plus )}\;(\Varid{l},\Varid{singl}\;\text{\ttfamily \char34 MUL\char34}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{inL2D}\mathrel{=}\alt{\Conid{Unid}}{\uncurry{((\Varid{result})\;\uncurry{\cdot }\;(\Conid{Comp}))}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{outL2D}\mathbin{::}\Conid{X}\;\Varid{a}\;\Varid{b}\to \Varid{a}+(\Varid{b},(\Conid{X}\;\Varid{a}\;\Varid{b},\Conid{X}\;\Varid{a}\;\Varid{b})){}\<[E]%
\\
\>[B]{}\Varid{outL2D}\;(\Conid{Unid}\;\Varid{d})\mathrel{=}i_1\;\Varid{d}{}\<[E]%
\\
\>[B]{}\Varid{outL2D}\;(\Conid{Comp}\;\Varid{b}\;\Varid{x1}\;\Varid{x2})\mathrel{=}i_2\;(\Varid{b},(\Varid{x1},\Varid{x2})){}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{collectLeafs}\mathbin{::}\Conid{X}\;\Varid{a}\;\Varid{b}\to [\mskip1.5mu \Varid{a}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{collectLeafs}\mathrel{=}\Varid{cataL2D}\;\alt{\Varid{singl}}{\uncurry{(\plus )}\comp \p2}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{dimen}\mathbin{::}\Conid{X}\;\Conid{Caixa}\;\Conid{Tipo}\to (\Conid{Float},\Conid{Float}){}\<[E]%
\\
\>[B]{}\Varid{dimen}\mathrel{=}\Varid{cataL2D}\;\alt{\Varid{f}}{\Varid{g}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{f}\mathbin{::}\Conid{Caixa}\to (\Conid{Float},\Conid{Float}){}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{f}\;((\Varid{a1},\Varid{a2}),\anonymous )\mathrel{=}(\Varid{fromIntegral}\;\Varid{a1},\Varid{fromIntegral}\;\Varid{a2}){}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{g}\mathbin{::}(\Conid{Tipo},((\Conid{Float},\Conid{Float}),(\Conid{Float},\Conid{Float})))\to (\Conid{Float},\Conid{Float}){}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{g}\;(\Varid{t},((\Varid{x1},\Varid{y1}),(\Varid{x2},\Varid{y2})))\mathrel{=}\mathbf{case}\;\Varid{t}\;\mathbf{of}{}\<[E]%
\\
\>[5]{}\hsindent{14}{}\<[19]%
\>[19]{}\Conid{V}{}\<[22]%
\>[22]{}\to (\Varid{max}\;\Varid{x1}\;\Varid{x2},\Varid{y1}\mathbin{+}\Varid{y2}){}\<[E]%
\\
\>[5]{}\hsindent{14}{}\<[19]%
\>[19]{}\Conid{Vd}\to (\Varid{max}\;\Varid{x1}\;\Varid{x2},\Varid{y1}\mathbin{+}\Varid{y2}){}\<[E]%
\\
\>[5]{}\hsindent{14}{}\<[19]%
\>[19]{}\Conid{Ve}\to (\Varid{max}\;\Varid{x1}\;\Varid{x2},\Varid{y1}\mathbin{+}\Varid{y2}){}\<[E]%
\\
\>[5]{}\hsindent{14}{}\<[19]%
\>[19]{}\Conid{H}{}\<[22]%
\>[22]{}\to (\Varid{x1}\mathbin{+}\Varid{x2},\Varid{max}\;\Varid{y1}\;\Varid{y2}){}\<[E]%
\\
\>[5]{}\hsindent{14}{}\<[19]%
\>[19]{}\Conid{Hb}\to (\Varid{x1}\mathbin{+}\Varid{x2},\Varid{max}\;\Varid{y1}\;\Varid{y2}){}\<[E]%
\\
\>[5]{}\hsindent{14}{}\<[19]%
\>[19]{}\Conid{Ht}\to (\Varid{x1}\mathbin{+}\Varid{x2},\Varid{max}\;\Varid{y1}\;\Varid{y2}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{calcOrigins}\mathbin{::}((\Conid{X}\;\Conid{Caixa}\;\Conid{Tipo}),\Conid{Origem})\to \Conid{X}\;(\Conid{Caixa},\Conid{Origem})\;(){}\<[E]%
\\
\>[B]{}\Varid{calcOrigins}\;(\Conid{Unid}\;\Varid{d},\Varid{o})\mathrel{=}\Conid{Unid}\;(\Varid{d},\Varid{o}){}\<[E]%
\\
\>[B]{}\Varid{calcOrigins}\;(\Conid{Comp}\;\Varid{b}\;\Varid{x1}\;\Varid{x2},\Varid{o})\mathrel{=}\Conid{Comp}\;()\;(\Varid{calcOrigins}\;(\Varid{x1},\Varid{o}))\;(\Varid{calcOrigins}\;(\Varid{x2},\Varid{calc}\;\Varid{b}\;\Varid{o}\;(\Varid{dimen}\;\Varid{x1}))){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{agrupCaixas}\mathbin{::}\Conid{X}\;(\Conid{Caixa},\Conid{Origem})\;()\to \Conid{Fig}{}\<[E]%
\\
\>[B]{}\Varid{agrupCaixas}\;(\Conid{Unid}\;(\Varid{c},\Varid{o}))\mathrel{=}[\mskip1.5mu (\Varid{o},\Varid{c})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{agrupCaixas}\;(\Conid{Comp}\;()\;\Varid{x1}\;\Varid{x2})\mathrel{=}\Varid{agrupCaixas}\;\Varid{x1}\plus \Varid{agrupCaixas}\;\Varid{x2}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{calc}\mathbin{::}\Conid{Tipo}\to \Conid{Origem}\to (\Conid{Float},\Conid{Float})\to \Conid{Origem}{}\<[E]%
\\
\>[B]{}\Varid{calc}\;\Varid{t}\;(\Varid{o1},\Varid{o2})\;(\Varid{dx},\Varid{dy})\mathrel{=}\mathbf{case}\;\Varid{t}\;\mathbf{of}{}\<[E]%
\\
\>[B]{}\hsindent{17}{}\<[17]%
\>[17]{}\Conid{V}{}\<[20]%
\>[20]{}\to (\Varid{o1}\mathbin{+}\Varid{dx}\mathbin{/}\mathrm{2},\Varid{o2}\mathbin{+}\Varid{dy}){}\<[E]%
\\
\>[B]{}\hsindent{17}{}\<[17]%
\>[17]{}\Conid{Vd}\to (\Varid{o1}\mathbin{+}\Varid{dx},\Varid{o2}\mathbin{+}\Varid{dy}){}\<[E]%
\\
\>[B]{}\hsindent{17}{}\<[17]%
\>[17]{}\Conid{Ve}\to (\Varid{o1},\Varid{o2}\mathbin{+}\Varid{dy}){}\<[E]%
\\
\>[B]{}\hsindent{17}{}\<[17]%
\>[17]{}\Conid{H}{}\<[20]%
\>[20]{}\to (\Varid{o1}\mathbin{+}\Varid{dx},\Varid{o2}\mathbin{+}\Varid{dy}\mathbin{/}\mathrm{2}){}\<[E]%
\\
\>[B]{}\hsindent{17}{}\<[17]%
\>[17]{}\Conid{Hb}\to (\Varid{o1}\mathbin{+}\Varid{dx},\Varid{o2}){}\<[E]%
\\
\>[B]{}\hsindent{17}{}\<[17]%
\>[17]{}\Conid{Ht}\to (\Varid{o1}\mathbin{+}\Varid{dx},\Varid{o2}\mathbin{+}\Varid{dy}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{caixasAndOrigin2Pict}\mathbin{::}(\Conid{X}\;\Conid{Caixa}\;\Conid{Tipo},\Conid{Origem})\to \Conid{\Conid{G}.Picture}{}\<[E]%
\\
\>[B]{}\Varid{caixasAndOrigin2Pict}\mathrel{=}\Conid{\Conid{G}.Pictures}\comp \Varid{crCaixa2}\comp \Varid{agrupCaixas}\comp \Varid{calcOrigins}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{mostraCaixas}\mathbin{::}(\Conid{L2D},\Conid{Origem})\to \fun{IO}\;(){}\<[E]%
\\
\>[B]{}\Varid{mostraCaixas}\mathrel{=}\Varid{display}\comp \Varid{caixasAndOrigin2Pict}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{crCaixa2}\mathbin{::}\Conid{Fig}\to [\mskip1.5mu \Conid{\Conid{G}.Picture}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{crCaixa2}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{crCaixa2}\;((\Varid{o},((\Varid{x},\Varid{y}),(\Varid{text},\Varid{color})))\mathbin{:}\Varid{t})\mathrel{=}\Varid{crCaixa}\;\Varid{o}\;(\Varid{fromIntegral}\;\Varid{x})\;(\Varid{fromIntegral}\;\Varid{y})\;\Varid{text}\;\Varid{color}\mathbin{:}\Varid{crCaixa2}\;\Varid{t}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{loop}\;(\Varid{coss},\Varid{rec1},\Varid{rec2},\Varid{rec3})\mathrel{=}(\Varid{coss}\mathbin{+}\Varid{rec1},\Varid{rec1}\mathbin{*}(\mathbin{-}\Varid{square}\;(\Varid{x})\mathbin{/}\Varid{rec2}),\Varid{rec2}\mathbin{+}\Varid{rec3},\Varid{rec3}\mathbin{+}\mathrm{8}){}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{init}\mathrel{=}(\mathrm{1},\mathbin{-}\Varid{square}\;(\Varid{x})\mathbin{/}\mathrm{2},\mathrm{12},\mathrm{18}){}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{prj}\;(\Varid{coss},\Varid{rec1},\Varid{rec2},\Varid{rec3})\mathrel{=}\Varid{coss}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{coss}\mathbin{::}(\Conid{Num}\;\Varid{a},\Conid{Eq}\;\Varid{a},\Conid{Floating}\;\Varid{a},\Conid{Integral}\;\Varid{a})\Rightarrow \Varid{a}\to \Varid{a}\to \Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{coss}\;\Varid{x}\;\mathrm{0}\mathrel{=}\mathrm{1}{}\<[E]%
\\
\>[B]{}\Varid{coss}\;\Varid{x}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}(\Varid{coss}\;\Varid{x}\;\Varid{n})\mathbin{+}(\Varid{rec1}\;\Varid{x}\;\Varid{n}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{rec1}\mathbin{::}(\Conid{Num}\;\Varid{a},\Conid{Eq}\;\Varid{a},\Conid{Floating}\;\Varid{a},\Conid{Integral}\;\Varid{a})\Rightarrow \Varid{a}\to \Varid{a}\to \Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{rec1}\;\Varid{x}\;\mathrm{0}\mathrel{=}\mathbin{-}\Varid{square}\;(\Varid{x})\mathbin{/}\mathrm{2}{}\<[E]%
\\
\>[B]{}\Varid{rec1}\;\Varid{x}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}(\Varid{rec1}\;\Varid{x}\;\Varid{n})\mathbin{*}(\mathbin{-}\Varid{square}\;(\Varid{x})\mathbin{/}\Varid{rec2}\;\Varid{x}\;\Varid{n}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{rec2}\mathbin{::}(\Conid{Num}\;\Varid{a},\Conid{Eq}\;\Varid{a},\Conid{Floating}\;\Varid{a},\Conid{Integral}\;\Varid{a})\Rightarrow \Varid{a}\to \Varid{a}\to \Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{rec2}\;\Varid{x}\;\mathrm{0}\mathrel{=}\mathrm{12}{}\<[E]%
\\
\>[B]{}\Varid{rec2}\;\Varid{x}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}(\Varid{rec2}\;\Varid{x}\;\Varid{n})\mathbin{+}(\Varid{rec3}\;\Varid{x}\;\Varid{n}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{rec3}\mathbin{::}(\Conid{Num}\;\Varid{a},\Conid{Eq}\;\Varid{a},\Conid{Floating}\;\Varid{a},\Conid{Integral}\;\Varid{a})\Rightarrow \Varid{a}\to \Varid{a}\to \Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{rec3}\;\Varid{x}\;\mathrm{0}\mathrel{=}\mathrm{18}{}\<[E]%
\\
\>[B]{}\Varid{rec3}\;\Varid{x}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}(\Varid{rec3}\;\Varid{x}\;\Varid{n})\mathbin{+}\mathrm{8}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{square}\mathbin{::}(\Conid{Num}\;\Varid{a},\Conid{Eq}\;\Varid{a},\Conid{Floating}\;\Varid{a})\Rightarrow \Varid{a}\to \Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{square}\;\Varid{num}\mathrel{=}\Varid{num}\mathbin{*}\Varid{num}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{13}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{outFS}\mathbin{::}\Conid{FS}\;\Varid{a}\;\Varid{b}\to [\mskip1.5mu (\Varid{a},\Varid{b}+(\Conid{FS}\;\Varid{a}\;\Varid{b}))\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{outFS}\;(\Conid{FS}\;[\mskip1.5mu \mskip1.5mu])\mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{outFS}\;(\Conid{FS}\;((\Varid{a},\Varid{b})\mathbin{:}\Varid{t}))\mathrel{=}(\Varid{a},\Varid{outNode}\;\Varid{b})\mathbin{:}\Varid{outFS}\;(\Conid{FS}\;\Varid{t}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{outNode}\;(\Conid{File}\;\Varid{b})\mathrel{=}i_1\;\Varid{b}{}\<[E]%
\\
\>[B]{}\Varid{outNode}\;(\Conid{Dir}\;(\Conid{FS}\;\Varid{a}))\mathrel{=}i_2\;(\Conid{FS}\;\Varid{a}){}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{cataFS}\;\Varid{g}\mathrel{=}{}\<[13]%
\>[13]{}\Varid{g}\comp (\Varid{recFS}\;(\Varid{cataFS}\;\Varid{g}))\comp \Varid{outFS}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\xymatrix@C=2cm{
    \ensuremath{\Conid{FS}\;\Varid{a}\;\Varid{b}}
           \ar[d]_-{\ensuremath{\cata{\Varid{g}}}}
&
    \ensuremath{(\Varid{a}\times(\Varid{b}\mathbin{+}\Conid{FS}\;\Varid{a}\;\Varid{b}))\mathbin{*}}
           \ar[d]^{\ensuremath{\map \;(\Varid{id}\times(\Varid{id}\mathbin{+}\cata{\Varid{g}}))}}
           \ar[l]_-{\ensuremath{\mathsf{in}}}
\\
     \ensuremath{\Varid{c}}
&
     \ensuremath{(\Varid{a}\times(\Varid{b}\mathbin{+}\Varid{c}))\mathbin{*}}
           \ar[l]^-{\ensuremath{\Varid{g}}}
}
\end{eqnarray*}
...
\\
\>[B]{}\Varid{check}\mathrel{=}\Varid{cataFS}\;(\neg \comp \Varid{hasDuplicatesOrFalses}\comp \map \;(\Varid{id}\times(\Varid{fromRight}\;\Conid{True}))){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{hasDuplicatesOrFalses}\mathbin{::}(\Conid{Eq}\;\Varid{a})\Rightarrow [\mskip1.5mu (\Varid{a},\Conid{Bool})\mskip1.5mu]\to \Conid{Bool}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{hasDuplicatesOrFalses}\;\Varid{xs}\mathrel{=}\length \;(\Varid{nub}\;\Varid{xs})\not\equiv \length \;\Varid{xs}\mathrel{\vee}\length \;(\Varid{filter}\;(\equiv \Conid{True})\;(\map \;\p2\;\Varid{xs}))\not\equiv \length \;\Varid{xs}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{tar}\mathbin{::}\Conid{FS}\;\Varid{a}\;\Varid{b}\to [\mskip1.5mu (\Conid{Path}\;\Varid{a},\Varid{b})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{tar}\mathrel{=}\Varid{cataFS}\;(\Varid{concat}\comp \map \;\Varid{f}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{f}\mathbin{::}(\Varid{a},\Varid{b}+[\mskip1.5mu (\Conid{Path}\;\Varid{a},\Varid{b})\mskip1.5mu])\to [\mskip1.5mu (\Conid{Path}\;\Varid{a},\Varid{b})\mskip1.5mu]{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{f}\;(\Varid{a},(i_1\;\Varid{x}))\mathrel{=}[\mskip1.5mu (\Varid{singl}\;\Varid{a},\Varid{x})\mskip1.5mu]{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{f}\;(\Varid{a},(i_2\;\Varid{x}))\mathrel{=}\Varid{addElementInPair}\;\Varid{x}\;\Varid{a}{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{untar}\mathrel{=}\Varid{joinDupDirs}\comp \Varid{anaFS}\;(\map \;\Varid{f}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{f}\mathbin{::}(\Conid{Path}\;\Varid{a},\Varid{b})\to (\Varid{a},\Varid{b}+[\mskip1.5mu (\Conid{Path}\;\Varid{a},\Varid{b})\mskip1.5mu]){}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{f}\;([\mskip1.5mu \Varid{a}\mskip1.5mu],\Varid{b})\mathrel{=}(\Varid{a},i_1\;\Varid{b}){}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{f}\;((\Varid{h}\mathbin{:}\Varid{t}),\Varid{b})\mathrel{=}(\Varid{h},i_2\;[\mskip1.5mu (\Varid{t},\Varid{b})\mskip1.5mu]){}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{find}\;\Varid{a}\mathrel{=}\Varid{cataFS}\;((\Varid{filtraPaths}\;\Varid{a})\comp \Varid{concat}\comp (\map \;\Varid{f})){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{f}\mathbin{::}(\Conid{Eq}\;\Varid{a})\Rightarrow (\Varid{a},\Varid{b}+[\mskip1.5mu \Conid{Path}\;\Varid{a}\mskip1.5mu])\to [\mskip1.5mu \Conid{Path}\;\Varid{a}\mskip1.5mu]{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{f}\;(\Varid{a},(i_1\;\Varid{x}))\mathrel{=}[\mskip1.5mu \Varid{singl}\;\Varid{a}\mskip1.5mu]{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{f}\;(\Varid{a},(i_2\;\Varid{x}))\mathrel{=}\Varid{addElement}\;\Varid{x}\;\Varid{a}{}\<[E]%
\\[\blanklineskip]%
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{addElementInPair}\mathbin{::}[\mskip1.5mu ([\mskip1.5mu \Varid{a}\mskip1.5mu],\Varid{b})\mskip1.5mu]\to \Varid{a}\to [\mskip1.5mu ([\mskip1.5mu \Varid{a}\mskip1.5mu],\Varid{b})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{addElementInPair}\;[\mskip1.5mu \mskip1.5mu]\;\anonymous \mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{addElementInPair}\;((\Varid{a},\Varid{b})\mathbin{:}\Varid{t})\;\Varid{x}\mathrel{=}(\Varid{x}\mathbin{:}\Varid{a},\Varid{b})\mathbin{:}\Varid{addElementInPair}\;\Varid{t}\;\Varid{x}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{addElement}\mathbin{::}\Conid{Eq}\;\Varid{a}\Rightarrow [\mskip1.5mu [\mskip1.5mu \Varid{a}\mskip1.5mu]\mskip1.5mu]\to \Varid{a}\to [\mskip1.5mu [\mskip1.5mu \Varid{a}\mskip1.5mu]\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{addElement}\;[\mskip1.5mu \mskip1.5mu]\;\anonymous \mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{addElement}\;(\Varid{a}\mathbin{:}\Varid{t})\;\Varid{x}\mathrel{=}(\Varid{x}\mathbin{:}\Varid{a})\mathbin{:}\Varid{addElement}\;\Varid{t}\;\Varid{x}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{filtraPaths}\mathbin{::}\Conid{Eq}\;\Varid{a}\Rightarrow \Varid{a}\to [\mskip1.5mu \Conid{Path}\;\Varid{a}\mskip1.5mu]\to [\mskip1.5mu \Conid{Path}\;\Varid{a}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{filtraPaths}\;\Varid{a}\mathrel{=}\Varid{filter}\;(\Varid{elem}\;\Varid{a}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
