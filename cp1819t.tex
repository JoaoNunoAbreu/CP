...
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{aux}\;((\Conid{Op}\;\Varid{o}),(\Varid{s1},\Varid{s2}))\mathrel{=}\Varid{s1}\plus \Varid{o}\plus \Varid{s2}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{hasDuplicates}\mathbin{::}(\Conid{Ord}\;\Varid{a})\Rightarrow [\mskip1.5mu \Varid{a}\mskip1.5mu]\to \Conid{Bool}{}\<[E]%
\\
\>[B]{}\Varid{hasDuplicates}\;\Varid{xs}\mathrel{=}\length \;(\Varid{nub}\;\Varid{xs})\not\equiv \length \;\Varid{xs}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
