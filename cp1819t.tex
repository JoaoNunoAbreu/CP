...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{show'}\;(\Conid{Num}\;\Varid{a})\mathrel{=}\Varid{show}\;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{show'}\;(\Conid{Bop}\;e_1 \;(\Conid{Op}\;\Varid{o})\;e_2 )\mathrel{=}\Varid{show'}\;e_1 \plus \Varid{o}\plus \Varid{show'}\;e_2 {}\<[E]%
\\[\blanklineskip]%
